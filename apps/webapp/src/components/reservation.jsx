...
function ReservationForm() {
  ...
  const onSubmit = async (e) => {
    ...
    setIsModalOpen(false);
    await axios
      .post("http://localhost:3000/add-customer", user)
      .then((response) => {
      ...
      <div className="form-elem">
        <div class="formbt">
          <Dropdown onSelect={(value) => onInputChangeSelect(value)}>
            ...
            <Dropdown.Menu>
              <Dropdown.Item eventKey="Standard Rooms" href="/ViewNonACSuite">
                View Standard Rooms
              </Dropdown.Item>
              <Dropdown.Item eventKey="Executive  Rooms" href="/ViewACSuitRoom">
                View Executive Rooms
              </Dropdown.Item>
              <Dropdown.Item eventKey="Premium Rooms" href="/ViewACNormalRoom">
                View Premium Rooms
              </Dropdown.Item>
              <Dropdown.Item
