...
function Intro(props) {
  ...
  return (
    <div>
      <h1 className="introHead">{HotelName}</h1>
      <div className="introdesc">
        ...
        <p>
          ...
          relaxation and indulgence. Indulge in the tranquility of our lush,
          sprawling gardens, and experience the warmth of our impeccable
          hospitality. Whether you seek a peaceful retreat or a memorable
          adventure, SIRI Ambari is your gateway to a world of unparalleled
          experiences and serenity.
        </p>
      </div>
