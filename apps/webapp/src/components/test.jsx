        ...
        <Carousel.Item>
          <div className="reviewsContainer">
            ...
            >
              ...
              <p className="reviewPara">
                Very, very spacious, clean washrooms and plenty of parking
                space. Vegetarian options: Dal khichdi was very good.
              </p>
            </div>
            <div
              className="reviews"
            ...
            >
              ...
              <p className="reviewPara">
                They have just started the restaurant where non veg and veg is
                served in separate buildings Food is good..the atmosphere is too
                good
              </p>
            </div>
          </div>
